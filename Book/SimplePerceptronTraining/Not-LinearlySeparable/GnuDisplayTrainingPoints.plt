...
set ytics 1  font ",20"
set key font ",20"
plot   'Class1.txt' with points title 'Class 1'  pt 7 ps 2
replot 'Class2.txt' with points title 'Class 2'  pt 3 ps 2
#set label "Untrained classifier" at 0.5,0.5 right font ",20"
#replot  +1-x linewidth 2

#set title "Epoch 4" font ",20"
#replot 0.354838709677419*x  + 2
replot 0.037037037037037*x+2.74074074074074
